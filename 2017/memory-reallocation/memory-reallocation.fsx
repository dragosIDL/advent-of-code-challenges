...
let input =
    File.ReadAllLines "2017/memory-reallocation/input.txt"
    |> Array.head
    |> fun s -> s.Split '\t'
    |> mapAsInt
...
let result = reallocation input // 7864, 1695
...
// solution to this is to record the step at which every state of the array happens
